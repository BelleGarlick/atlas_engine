...
import atlas.objects.entityComponents.animation.AnimatedFrame;
import atlas.objects.entityComponents.animation.AnimatedModel;
import atlas.objects.entityComponents.animation.Animation;
...
public class AnimMeshesLoader extends StaticMeshesLoader {
    ...
    public static AnimatedModel loadAnimGameItem(String resourcePath)
            throws Exception {
        return loadAnimGameItem(resourcePath,
...
//        }
        ...
        AnimatedModel item = new AnimatedModel(meshes, animations);

        return item;
    }
    
//    public static AnimatedModel loadAnimGameItem(String resourcePath, String texturesDir)
//            throws Exception {
...
//    }
    ...
    public static AnimatedModel loadAnimGameItem(String resourcePath, String texturesDir, int flags) throws Exception {
    	System.out.println("AnimMeshLoader: Uncomment");
//    	ByteBuffer resourceByteBuffer = Utils.ioResourceToByteBuffer(resourcePath,1024);
//    	ByteBuffer argsBuffer = BufferUtils.createByteBuffer(8);
//        AIScene aiScene = aiImportFileFromMemory(resourceByteBuffer, flags, argsBuffer);
//        if (aiScene == null) {
//            throw new Exception("Error loading model");
...
//        System.out.println("AnimMeshesLoader:processMesh: Uncomment");
...
//        }
//        System.out.println("AnimMeshesLoad: Set material mesh");
